...
public class News2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFetchFeedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new News2Fragment.FetchFeedTask().execute((Void) null);
            }
        });
    ...
    private class FetchFeedTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            try {
                if (!urlLink.startsWith("http://feeds.bbci.co.uk/sport/football/rss.xml?edition=uk#")
                        && !urlLink.startsWith("http://feeds.bbci.co.uk/sport/football/rss.xml?edition=uk#"))
                    urlLink = "http://feeds.bbci.co.uk/sport/football/rss.xml?edition=uk#" + urlLink;
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                ...
                Toast.makeText(News2Fragment.this.getActivity(),

...
public class News3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFetchFeedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new News3Fragment.FetchFeedTask().execute((Void) null);
            }
        });
    ...
    private class FetchFeedTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            try {
                if (!urlLink.startsWith("http://www.rotoworld.com/rss/feed.aspx?sport=nba&ftype=article&count=12&format=rss")
                        && !urlLink.startsWith("http://www.rotoworld.com/rss/feed.aspx?sport=nba&ftype=article&count=12&format=rss"))
                    urlLink = "http://www.rotoworld.com/rss/feed.aspx?sport=nba&ftype=article&count=12&format=rss" + urlLink;
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                ...
                Toast.makeText(News3Fragment.this.getActivity(),

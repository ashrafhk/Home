...
public class Stats1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_stats1, container, false);
    ...
    private class FetchFeedTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            try {
                if (!urlLink.startsWith("http://www.espncricinfo.com/rss/content/story/feeds/0.xml") && !urlLink.startsWith("http://www.espncricinfo.com/rss/content/story/feeds/0.xml"))
                    urlLink = "http://www.espncricinfo.com/rss/content/story/feeds/0.xml" + urlLink;
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                ...
                Toast.makeText(Stats1Fragment.this.getActivity(),

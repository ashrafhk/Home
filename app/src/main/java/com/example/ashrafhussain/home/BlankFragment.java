...
public class BlankFragment extends Fragment {
    ...
    private class FetchFeedTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            try {
                if (!urlLink.startsWith("http://static.espncricinfo.com/rss/livescores.xml") && !urlLink.startsWith("http://static.espncricinfo.com/rss/livescores.xml"))
                    urlLink = "http://static.espncricinfo.com/rss/livescores.xml" + urlLink;
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                ...
                Toast.makeText(BlankFragment.this.getActivity(),

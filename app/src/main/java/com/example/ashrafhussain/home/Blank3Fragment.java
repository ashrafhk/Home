...
public class Blank3Fragment extends Fragment {
    ...
    private class FetchFeedTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            try {
                if (!urlLink.startsWith("https://www.scorespro.com/rss2/live-basketball.xml")
                        && !urlLink.startsWith("https://www.scorespro.com/rss2/live-basketball.xml"))
                    urlLink = "https://www.scorespro.com/rss2/live-basketball.xml" + urlLink;
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                ...
                Toast.makeText(Blank3Fragment.this.getActivity(),
